...
public interface ITopKCommandsAsync
{
    /// <summary>
    ...
    Task<RedisResult[]?> AddAsync(RedisKey key, params RedisValue[] items);
    ...
    Task<RedisResult[]> IncrByAsync(RedisKey key, params Tuple<RedisValue, long>[] itemIncrements);
    /// <summary>
    ...
    Task<TopKInformation> InfoAsync(RedisKey key);
    ...
    Task<RedisResult[]> ListAsync(RedisKey key, bool withcount = false);
    ...
    Task<bool> QueryAsync(RedisKey key, RedisValue item);
    ...
    /// <remarks><seealso href="https://redis.io/commands/topk.query"/></remarks>
    Task<bool[]> QueryAsync(RedisKey key, params RedisValue[] items);
    ...
    Task<bool> ReserveAsync(RedisKey key, long topk, long width = 7, long depth = 8, double decay = 0.9);
}