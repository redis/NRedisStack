...
public class TestTimeSeriesRule
{
    ...
    {
        TimeSeriesRule rule = new("key", 50, TsAggregation.Avg);
    ...
    public void TestRuleEquals()
    {
        ...
        TimeSeriesRule rule1 = new("key", 50, TsAggregation.Avg);
        TimeSeriesRule rule2 = new("key2", 50, TsAggregation.Avg);
        TimeSeriesRule rule3 = new("key", 51, TsAggregation.Avg);
        TimeSeriesRule rule4 = new("key", 50, TsAggregation.Count);
