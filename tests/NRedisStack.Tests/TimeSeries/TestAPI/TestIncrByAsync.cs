...
public class TestIncrByAsync(EndpointsFixture endpointsFixture) : AbstractNRedisStackTest(endpointsFixture)
{
    [Fact]
    ...
    public async Task TestIncrByTimeStamp()
    {
        ...
        Assert.Equal(new(timeStamp, value), await ts.GetAsync(key));
    }
