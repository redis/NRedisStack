...
public class TestMRangeAsync(EndpointsFixture endpointsFixture) : AbstractNRedisStackTest(endpointsFixture)
{
    ...
    public async Task TestMRangeExcludeEmpty(string endpointId)
    {
        ...
        var pruned = await ts.MRangeAsync("-", "+", filter, flags: TimeSeriesRangeFlags.ExcludeEmpty);
