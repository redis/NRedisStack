    ...
    public void testCreateNode()
{
        ...
        // Assert.False(resultSet.iterator().hasNext());
...
//        Assert.NotNull(delStats.getstringValue(Label.QUERY_INTERNAL_EXECUTION_TIME));
        ...
        // Assert.False(deleteResult.iterator().hasNext());
...
//         Assert.Equal(Arrays.asList("a", "r", "a.name", "a.age", "a.doubleValue", "a.boolValue",
//                 "r.place", "r.since", "r.doubleValue", "r.boolValue"), record.keys());

//         Assert.Equal(Arrays.asList(expectedNode, expectedEdge,
...
//             Assert.Equal(expectedNode.getProperty(propertyName), a.getProperty(propertyName));
//         }

//         Assert.Equal("roi", record.getstring(2));
//         Assert.Equal("32", record.getstring(3));
//         Assert.Equal(32L, ((Long) record.getValue(3)).longValue());
//         Assert.Equal(32L, ((Long) record.getValue("a.age")).longValue());
...
//         Record record = iterator.next();
//         Assert.False(iterator.hasNext());
//         Assert.Equal(Arrays.asList("a", "r"), record.keys());
//         Assert.Equal(Arrays.asList(expectedNode, expectedEdge), record.values());
...
//         db.Execute("FLUSHALL");
//         var graph = db.GRAPH();
//         Dictionary<string, object> params1 = new HashDictionary<string, object>();
//         params1.put("s1", "S\"'");
//         params1.put("s2", "S'\"");
//         Assert.NotNull(graph.Query("social", "CREATE (:escaped{s1:$s1,s2:$s2})", params1));

//         Dictionary<string, object> params2 = new HashDictionary<string, object>();
//         params2.put("s1", "S\"'");
//         params2.put("s2", "S'\"");
...
//         Record record = iterator.next();
//         Assert.False(iterator.hasNext());
//         Assert.Equal(Arrays.asList("x"), record.keys());

//         List<Long> x = record.getValue("x");
//         Assert.Equal(Arrays.asList(0L, 1L, 2L), x);
...
//         Assert.Equal(Arrays.asList("x"), record.keys());
//         x = record.getValue("x");
//         Assert.Equal(Arrays.asList(expectedANode, expectedBNode), x);
...
//         Path path01 = new PathBuilder(2).append(nodes[0]).append(edges[0]).append(nodes[1]).build();
//         Path path12 = new PathBuilder(2).append(nodes[1]).append(edges[1]).append(nodes[2]).build();
//         Path path02 = new PathBuilder(3).append(nodes[0]).append(edges[0]).append(nodes[1])
...
//         Record record = iterator.next();
//         Assert.False(iterator.hasNext());
//         Assert.Equal(Arrays.asList(null, null, null), record.values());
...
//         Assert.NotNull(record.getValue(0));
//         Assert.NotNull(record.getValue(1));
//         Assert.NotNull(record.getValue(2));
...
//         ResultSet resultSet = graph.Query("social", "CREATE (n {val:$val}) RETURN n.val", params);
//         Assert.Equal(1, resultSet.Count);
//         Record r = resultSet.iterator().next();
//         Assert.Equal(Long.valueOf(value), r.getValue(0));
//     }
...
//         Dictionary<string, object> params = new HashMap<>();
//         params.put("val", 1L);
//         ResultSet resultSet = graph.Query("social", "MATCH (n:N {val:$val}) RETURN n.val", params);
//         Assert.Equal(1, resultSet.Count);
//         Record r = resultSet.iterator().next();
//         Assert.Equal(params.get("val"), r.getValue(0));
...
//         for (int i = 0; i < 64; i++) {
//             resultSet = graph.Query("social", "MATCH (n:N {val:$val}) RETURN n.val", params);
//         }
//         Assert.Equal(1, resultSet.Count);
//         r = resultSet.iterator().next();
//         Assert.Equal(params.get("val"), r.getValue(0));
//         assertTrue(resultSet.Statistics.cachedExecution());
//     }
...
//         db.Execute("FLUSHALL");
//         var graph = db.GRAPH();
//         Dictionary<string, object> expected = new HashMap<>();
...
//         expected.put("d", d);
//         expected.put("e", true);
//         Dictionary<string, object> f = new HashMap<>();
//         f.put("x", (long) 1);
//         f.put("y", (long) 2);
//         expected.put("f", f);
...
//         Dictionary<string, object> actual = r.getValue(0);
...
//         Assert.Equal(Long.valueOf(100), r.getValue(0));
//     }
...
//         Dictionary<string, object> params = new HashMap<>();
//         params.put("val", 1L);
//         ResultSet resultSet =   graph.ReadonlyQuery("social", "MATCH (n:N {val:$val}) RETURN n.val", params);
//         Assert.Equal(1, resultSet.Count);
//         Record r = resultSet.iterator().next();
//         Assert.Equal(params.get("val"), r.getValue(0));
//         Assert.False(resultSet.Statistics.cachedExecution());
...
//         // from cache at least once
//         for (int i = 0; i < 64; i++) {
//             resultSet =   graph.ReadonlyQuery("social", "MATCH (n:N {val:$val}) RETURN n.val", params);
//         }
//         Assert.Equal(1, resultSet.Count);
//         r = resultSet.iterator().next();
//         Assert.Equal(params.get("val"), r.getValue(0));
...
//         ResultSet rsRo = graph.ReadonlyQuery("social", "MATCH (a:person) WHERE (a.name = 'filipe') RETURN a.age");
//         Assert.Equal(1, rsRo.Count);
//         Record r = rsRo.iterator().next();
//         Assert.Equal(Long.valueOf(30), r.getValue(0));
//     }
