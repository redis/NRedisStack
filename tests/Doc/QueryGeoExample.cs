...
public class QueryGeoExample
{
    ...
    public void run()
    {
        ...
        Console.WriteLine(string.Join(", ", res1.Documents.Select(d => d.Id)));
        // >>> bicycle:5
        // STEP_END
        ...
        Assert.Equal("bicycle:5", string.Join(", ", res1.Documents.Select(d => d.Id)));
        // REMOVE_END
        ...
        Console.WriteLine(string.Join(", ", res2.Documents.Select(d => d.Id)));
        // >>> bicycle:5
        // STEP_END
        ...
        Assert.Equal("bicycle:5", string.Join(", ", res2.Documents.Select(d => d.Id)));
        // REMOVE_END
        ...
        Console.WriteLine(string.Join(", ", res3.Documents.Select(d => d.Id)));
        ...
        Assert.Equal(
            "bicycle:5, bicycle:6, bicycle:7, bicycle:8, bicycle:9",
            string.Join(", ", res3.Documents.Select(d => d.Id))
        );
        // REMOVE_END
